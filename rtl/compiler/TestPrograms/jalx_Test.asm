# ---------- Initialization ----------
addi r1  r1  r1  1       # r1 = 1 ra, rb, rd, immediate 
addi r2  r2  r2  2       # r2 = 2
addi r3  r3  r3  2       # r3 = 2


# ---------- Jump 1: Skip 2 instructions ----------
jalx  r1 r2 r3  7    # jump to pc 8 skip next 2 PC=3
...
jalx r3 r2 r1  0     # jump to pc 3 PC=8
addi r13 r13 r13 66      # skipped
addi r14 r14 r14 55      # skipped
addi r15 r15 r15 44      # skipped
addi r16 r16 r16 33      # executes after jump

jalx r3 r2 r1  1     # jump to pc 3 PC=13
addi r20 r20 r20 11      # skipped
addi r21 r21 r21 22      # skipped
addi r22 r22 r22 33      # executes after jump
